...
class FruitsData:
    ...
    fruits_data = [
        ...
        ["Açaí", 0.5, 1, 1.1, 1.4, 0.0, 0.1, 1.1, 1.4, 3.0, 4.0],
        ["Plum", 2, 5, 0.9, 1.2, 0.0, 0.1, 0.9, 1.2, 3.8, 4.6],
        ["Cashew", 2, 4, 0.7, 1.1, 0.0, 0.1, 0.7, 1.1, 4.5, 5.5],
        ["Cherry", 1, 2, 0.9, 1.1, 0.0, 0.1, 0.9, 1.1, 3.0, 4.0],
        ["Guava", 5, 10, 0.6, 1.0, 0.2, 0.3, 0.6, 1.0, 3.5, 4.5],
        ["Jabuticaba", 1, 3, 1.0, 1.3, 0.0, 0.1, 1.0, 1.3, 4.0, 5.0],
        ...
        ["Apple", 6, 8, 0.8, 1.0, 0.0, 0.1, 0.8, 1.0, 3.5, 4.0],
        ...
        ["Pear", 5, 8, 0.8, 1.1, 0.0, 0.1, 0.8, 1.1, 3.0, 4.0],
        ...
        ["Tomato", 2, 5, 0.9, 1.3, 0.0, 0.1, 0.9, 1.3, 4.0, 4.8],
